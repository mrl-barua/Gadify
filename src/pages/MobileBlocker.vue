<template>
  <div>
    <div v-if="isSmallDevice" class="mobile-blocker">
      <div class="message">
        <div class="icon">
          <svg
            width="200px"
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              <path
                ...
                fill="#843A5F"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-text-843a5f, #c77fa3)"
              />
              ...
              <path
                ...
                fill="#843A5F"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-background-843a5f, #6a2e4c)"
              />
              ...
              <path
                ...
                fill="#AE9AA4"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-background-ae9aa4, #4b5255)"
              />
              ...
              <path
                ...
                fill="#FFFFFF"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-text-ffffff, #e8e6e3)"
              />
              ...
              <path
                ...
                fill="#E6D8DF"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-background-e6d8df, #36232d)"
              />
              ...
              <path
                ...
                fill="#E6D8DF"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-text-e6d8df, #d4d0ca)"
              />
              ...
              <path
                ...
                fill="#FF9FB9"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-text-ff9fb9, #ff89a9)"
              />
              ...
              <path
                d="M512 684.2m-126.4 0a126.4 126.4 0 1 0 252.8 0 126.4 126.4 0 1 0-252.8 0Z"
                fill="#FFFFFF"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-background-ffffff, #181a1b)"
              />
              ...
              <path
                d="M638.4 684.2c0 69.8-56.6 126.4-126.4 126.4S385.7 754 385.7 684.2"
                fill="#E6D8DF"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-background-e6d8df, #36232d)"
              />
              ...
              <path
                d="M433.3 894.4l-32.3-56h64.6zM512.7 894.4l-32.3-56H545zM590.8 894.4l-32.4-56h64.7z"
                fill="#843A5F"
                data-darkreader-inline-fill=""
                style="--darkreader-inline-fill: var(--darkreader-background-843a5f, #6a2e4c)"
              />
        ...
        <h1>Desktop Only</h1>
        <p>This application is only available on desktop or laptop devices.</p>
        <p class="device-info">Please access from a device with a larger screen.</p>
      </div>
    </div>
    <div v-else>
      <slot></slot>
...
const checkDeviceSize = () => {
  // Block access for screens smaller than 1024px (phones and tablets)
