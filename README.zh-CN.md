...
<p align="center">
  ...
  <a href="https://admin-landing.vuestic.dev/"> 关于Gadify Management </a> |
  <a href="https://ui.vuestic.dev/">Vuestic UI文档</a>
</p>

> Gadify Management是使用[Vuestic UI](https://ui.vuestic.dev)构建的。查看我们的
> <a href="https://github.com/epicmaxco/vuestic-ui/issues">问题</a>，
> <a href="https://ui.vuestic.dev/en/contribution/guide">贡献指南</a> 并参与我们的
> <a href="https://discord.gg/jTKTjj2weV">Discord服务器</a>，帮助我们改进Gadify Management和Vuestic UI体验。
...
使用以下命令快速搭建新的[Gadify Management](admin-demo.vuestic.ui)或使用[Vuestic UI](ui.vuestic.dev)的空白Vite或Nuxt项目。

```bash
npm create vuestic@latest
```

安装[Gadify Management](admin.vuestic.ui)后，运行 `npm install` 安装依赖，然后运行 `npm run dev` 启动本地开发服务器。
...
[Epicmax](https://epicmax.co) 从一开始就致力于开源。Gadify Management是由Epicmax创建并支持的，经过多年的支持。
